...
create table delivery(
    ...
    truck_num       integer references truck (truck_id)
);
...
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (1 , 'done' , '10-1-2020' , 1);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (3, 'done', '6-2-2020', 2);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (4, 'done', '9-3-2020', 3);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (5, 'done', '8-3-2020', 4);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (6, 'done', '10-3-2020', 1);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (7, 'done',  '12-3-2020', 3);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (8, 'done',  '18-3-2020', 4);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (9, 'done', '11-4-2020', 1);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (10, 'done', '11-4-2020', 2);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (11, 'done', '3-5-2020', 3);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (12, 'done', '20-6-2020', 4);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (13, 'done', '19-7-2020', 1);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (14, 'done', '29-12-2020', 2);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (15, 'done', '1-4-2021', 3);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (16, 'done', '1-6-2021', 4);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (17, 'done', '4-9-2021', 1);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (18, 'in proccess', '1-12-2021', 2);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (19, 'done', '13-12-2021', 1);
insert into delivery (package_id, delivery_status , delivered_time, truck_num ) values (20, 'in proccess', '13-12-2021', 1);
...
WHERE truck_number = 1721 AND delivery.truck_num = truck.truck_id;

SELECT package.package_id FROM package, delivery, truck
WHERE id=(SELECT max(id) FROM delivery WHERE truck_num=1721 AND delivery_status='done');
...
FROM customers, package, invoices WHERE package.customer_id = customer.customer_id AND package.package_id = invoices.package_id GROUP BY customer_id, customer_name;
